        ...
        <>
            ...
            >
                ...
                >
                    <button
                        type="submit"
                        className={`ml-4 p-2 size-10 my-auto text-gray-500 hover:text-gray-700 dark:text-white/70 dark:hover:text-[#ff952aff] transition-all duration-500 ease-out cursor-pointer ${hasValue ? 'flex ' : 'hidden'} `}
                        title="Rechercher"
                    >
                    ...
                    {hasValue && (
                        <button
                            ...
                            className="p-1 mr-2 text-gray-500 hover:text-gray-700 dark:text-white/70 dark:hover:text-red-600 transition-all duration-500 ease-out cursor-pointer"
                    ...
                    <ul className={`mobile-menu flex items-start min-[1025px]:items-center gap-4 min-[1025px]:gap-6 text-base xl:text-lg font-medium max-[1025px]:flex-col max-[1025px]:absolute max-[1025px]:top-full max-[1025px]:left-0 max-[1025px]:w-full bg-[#FCFFF7] dark:bg-[#222222] max-[1025px]:shadow-lg max-[1025px]:py-4 max-[1025px]:px-5 ${isMobileMenuOpen ? 'flex' : 'hidden'} min-[1025px]:flex rounded-b-2xl`}>
                        ...
                        {!isMounted ? (
                            ...
                            <li className="relative max-[1025px]:hidden" ref={userMenuRef}>
                                ...
                                {isUserMenuOpen && (
                                    <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-[#222222] rounded-lg shadow-[0_10px_15px_rgb(0,0,0,0.4)] hover:shadow-[0_12px_20px_rgb(0,0,0,0.5)] dark:shadow-[0_15px_25px_rgb(0,0,0,0.8)] dark:hover:shadow-[0_15px_25px_rgb(0,0,0,0.9)] py-2 z-20 border border-gray-300 dark:border-white/20">
