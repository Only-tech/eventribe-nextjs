...
export default async function AdminDashboardPage() {
  ...
  return (
    <div className="p-3">
      <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white mb-8 text-center">Tableau de bord Administrateur</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden p-6 text-center">
          ...
          <div className="flex items-center justify-center gap-2">
            <UsersIcon className="w-10 h-10 text-gray-700 dark:text-gray-500" />
            <p className="text-5xl font-bold text-gray-700 dark:text-gray-500">{totalUsers}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden p-6 text-center">
          ...
          <div className="flex items-center justify-center gap-2">
            <TicketIcon className="w-10 h-10 text-gray-700 dark:text-gray-500" />
            <p className="text-5xl font-bold text-gray-700 dark:text-gray-500">{totalRegistrations}</p>
          </div>
        </div>
      </div>

      <div className="bg-white max-w-7xl rounded-lg shadow-lg [@media(max-width:412px)]:px-2 p-6 mx-auto">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Actions Administrateur</h2>
