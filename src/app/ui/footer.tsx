    ...
    <footer className="bg-[#f5f5dc] text-gray-700 pt-10 pb-2 w-full">
      <div className="flex flex-wrap gap-20 justify-between pb-10 w-full max-w-[95%] px-3 mx-auto">
        ...
        <div className="[@media(max-width:849px)]:order-1 [@media(max-width:849px)]:justify-center mx-auto">
          <h3 className="text-2xl text-gray-800 border-b-1 font-bold pb-1 mb-6">Navigation</h3>
        ...
        <div className="[@media(max-width:849px)]:order-2 [@media(max-width:849px)]:justify-center mx-auto">
          <div className="mb-6">
            <h3 className="text-2xl text-gray-800 border-b-1 font-bold pb-1 mb-4">Nos partenaires</h3>
          ...
          <Link href="/" className="relative text-2xl text font-semibold mb-2 md:mb-0 w-25 h-25 flex items-center justify-center group mx-auto [@media(max-width:849px)]:order-4" title="eventribe, plus proches des événements à venir">
              <span className="relative z-10 group-hover:text-[#ff952aff] bg-[#f5f5dc] transition-colors duration-300 ease-in-out cursor-pointer">eventribe</span>
              <Image
