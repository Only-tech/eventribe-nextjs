...
export function ConfirmationEmail(firstName: string, lastName: string, eventTitle: string): string {
    return `
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="max-width:600px;padding:15px 20px;text-align:left;">
                                        ...
                                        <p>Votre inscription à l’événement <strong>${eventTitle}</strong> a bien été enregistrée.</p>
