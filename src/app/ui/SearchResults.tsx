    ...
    ({ results, isLoading, onClose, anchorRef }, ref) => {
        ...
        >
            <OverlayScrollbarsComponent
                ...
                defer
                className="w-full z-1 -top-11 bg-white dark:bg-[#303134] dark:hover:bg-[#292929] border-x border-b border-gray-200 dark:border-white/10 transform transition-transform duration-500 ease-out 
                        rounded-2xl md:rounded-3xl max-h-[71vh] overflow-hidden shadow-[0_12px_15px_rgb(0,0,0,0.5)] dark:shadow-[0_15px_18px_rgb(0,0,0,0.9)] shadow-[hsl(var(--always-black)/5.1%)]"
            >
