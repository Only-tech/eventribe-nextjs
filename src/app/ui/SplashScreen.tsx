  ...
  useEffect(() => {
    ...
    return (
        ...
        >
            ...
            <div className="min-h-60 flex flex-col justify-center items-center [background-color:#FCFFF7]/85 bg-[url('/images/SplashPaintBreak.svg')] bg-contain bg-fixed p-6 lg:p-12 rounded-2xl min-[500px]:[clip-path:var(--clip-path-squircle-60)]">
