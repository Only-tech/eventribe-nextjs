...
const FloatingLabelInput: React.FC<FloatingLabelInputProps> = ({ 
  ...
  // Class fusion
  const baseClasses = "peer block w-full px-3 pb-2 pt-3 border border-gray-300 dark:border-white/20 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-[#ff952aff] hover:border-[#ff952aff] focus:border-[#ff952aff] transition-all ease-in-out duration-400";
