    ...
    return (
        <div data-aos="fade-up">
            ...
            >
                ...
                <section className="py-3 px-3.5 text-sm flex-grow flex flex-col">
                    ...
                    <p className="text-gray-700 text-justify dark:text-white/65 mb-3 flex-grow">{event.description_short}</p>
