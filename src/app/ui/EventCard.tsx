...
export default function EventCard({ event }: EventCardProps) {
    ...
    return (
        <div className="max-w-md bg-[rgb(248,248,236)] rounded-lg shadow-lg overflow-hidden flex flex-col transform transition-transform duration-300 hover:shadow-2xl group" data-aos="fade-up">
        ...
        <div className="p-3 sm:p-4 md:p-6 flex-grow flex flex-col">
            <h2 className="text-center text-lg md:text-xl font-bold text-gray-900 mb-2">{event.title}</h2>
            ...
            <p className="text-center sm:text-justify text-gray-700 mb-4 flex-grow">{event.description_short}</p>
