  ...
  return (
    ...
    >
      <Link href="/admin" className="group" title="Administration">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 animate-pulse group-hover:animate-none transition-opacity duration-300 group-hover:opacity-65 group-hover:scale-110" fill="currentColor" viewBox="0 0 512 512" >
