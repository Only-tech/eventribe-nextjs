                ...
                >
                  ...
                  {(isMobile || (isActive && isHovered)) && (
                    <button
                      ...
                      className="absolute bottom-4 left-1/2 transform -translate-x-1/2 h-11 inline-flex items-center justify-center px-5 py-2 rounded-full text-base font-medium transition-colors group border-[0.5px] shadow-sm shadow-[hsl(var(--always-black)/5.1%)] bg-[#F0EEE5] hover:bg-[#E8E5D8] hover:border-transparent"
                    >
