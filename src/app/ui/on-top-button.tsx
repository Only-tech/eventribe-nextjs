...
export default function OnTopButton() {
    ...
    return (
        <button onClick={scrollToTop}
            className={`fixed bottom-8 right-8 z-1001 flex w-12 h-12 bg-[rgba(255,255,255,0.5)] hover:bg-white rounded-full overflow-hidden cursor-pointer justify-center items-center transition-opacity duration-300 ease-in-out group ${
            ...
            {/* Scroll Arrow SVG */}
            <svg className="relative w-6 h-6 animate-[moveButton_3s_infinite] transition-all duration-300 ease-in-out group-hover:animate-none group-active:scale-90" viewBox="34 -7.5 80 80" xmlns="http://www.w3.org/2000/svg">
